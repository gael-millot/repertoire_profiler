...
<span style="color:green">*productive_seq.tsv file in the [tsv](./tsv) folder*</span>
        ...
        if(is.data.frame(df) && truncated_log){
            cat('
(Note: Table truncated to 3 rows. Full file available in the productive_seq.tsv file.)<br><br>
            ')
        }
...
<span style="color:green">*unproductive_seq.tsv file in the [tsv](./tsv) folder*</span>
        ...
        if(is.data.frame(df) && truncated_log){
            cat('
(Note: Table truncated to 3 rows. Full file available in the unproductive_seq.tsv file.)<br><br>
            ')
        }
        cat(knitr::kable(df, format = "html", row.names = FALSE))
        cat('
...
<span style="color:green">*wanted_seq.tsv file in the [tsv](./tsv) folder*</span>
        ...
        if(is.data.frame(df) && truncated_log){
            cat('
(Note: Table truncated to 3 rows. Full file available in the wanted_seq.tsv file.)<br><br>
            ')
        }
        cat(knitr::kable(df, format = "html", row.names = FALSE))
        cat('
...
<span style="color:green">*unwanted_seq.tsv file in the [tsv](./tsv) folder*</span>
        ...
        if(is.data.frame(df) && truncated_log){
            cat('
(Note: Table truncated to 3 rows. Full file available in the unwanted_seq.tsv file.)<br><br>
            ')
        }
        cat(knitr::kable(df, format = "html", row.names = FALSE))
        cat('
...
<span style="color:green">*clone_assigned_seq.tsv file in the [tsv](./tsv) folder*</span>
        ...
        if(is.data.frame(df) && truncated_log){
            cat(paste0('
(Note: Table truncated to 3 rows. Full file available in the clone_assigned_seq.tsv file.)<br><br>
            ')
        }
        cat(knitr::kable(df, format = "html", row.names = FALSE))
        cat('
...
<span style="color:green">*failed_clone_assigned_seq.tsv file in the [tsv](./tsv) folder*</span>
        ...
        if(is.data.frame(df) && truncated_log){
            cat('
(Note: Table truncated to 3 rows. Full file available in the failed_clone_assigned_seq.tsv file.)<br><br>
            ')
        }
        cat(knitr::kable(df, format = "html", row.names = FALSE))
        cat('
...
<span style="color:green">*failed_clonal_germline_seq.tsv file in the [tsv](./tsv) folder*</span>
        ...
        if(is.data.frame(df) && truncated_log){
            cat(paste0('
\n(Note: Table truncated to 3 rows. Full file available in the failed_clonal_germline_seq.tsv file.)\n\n
            '))
            cat(knitr::kable(df, format = "html", row.names = FALSE))
            cat('
<br>
...
<span style="color:green">*clone_id_count.tsv file in the [tsv](./tsv) folder*</span>
        ...
        if(is.data.frame(df) && truncated_log){
            cat(paste0('
\n(Note: Table truncated to 3 rows. Full file available in the clone_id_count.tsv file.)\n\n
            '))
            cat(knitr::kable(df, format = "html", row.names = FALSE))
            cat('
<br>
...
<span style="color:green">*failed_abalign_align.tsv file in the [tsv](.) folder*</span>
        ...
        if(is.data.frame(df) && truncated_log){
            cat(paste0('
\n(Note: Table truncated to 3 rows. Full file available in the [tsv](.) folder.)\n\n
            '))
            cat(knitr::kable(df, format = "html", row.names = FALSE))
            cat('
<br>
