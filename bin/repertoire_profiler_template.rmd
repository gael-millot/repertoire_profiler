...
Click on a figure to enlarge. Reclick to go back to the report.
<br>
Only V, J and C genes are displayed here. See the [gene_repertoire.pdf](files/gene_repertoire.pdf) and [allele_repertoire.pdf](files/allele_repertoire.pdf) files in the files folder for the complete results, including the alleles (different copies of a same gene) proportions.
...
**Sequence alignment** are available in the [phylo/nuc](./phylo/nuc) folder for nucleotide alignments and in the [phylo/aa](./phylo/aa) folder for amino acids alignments. Folders include:<br /><ul><li>germline clustering (clone ID).<br /></li><li>allele reannotation (germinal_v_call and germinal_j_call columns).<br /></li><li>mutation load.<br /></li><li>distance and sequence nickname (annotation from the metadata file) added.<br></ul>
...
###  Amino acid sequences phylogeny for each clonal group
<br>
