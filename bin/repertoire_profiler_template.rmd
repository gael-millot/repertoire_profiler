...
`r  if(TRUE){"### Amino acid sequences phylogeny \n\n **Only available for heavy chain analysis.**  "}`
`r  if(TRUE){"Open the different sequences_\\<SEQ_NAME\\>_align.fasta_itol_url.txt files in the [phylo](./phylo) folder and click on the link to see the trees."}`
<br><br>
