...
df_productive <- read_tsv_with_dummy("files/productive_seq.tsv")
kable(df_productive, format = "markdown", row.names = FALSE)
```
</details>
<br>
...
```{r, echo=FALSE, results='asis'}
df_productive <- read_tsv_with_dummy("files/unproductive_seq.tsv")
kable(df_productive, format = "markdown", row.names = FALSE)
```
</details>
<br>
...
```{r, echo=FALSE, results='asis'}
df_productive <- read_tsv_with_dummy("files/clone_assigned_seq.tsv")
kable(df_productive, format = "markdown", row.names = FALSE)
```
</details>
```{r include = FALSE}
...
```{r, echo=FALSE, results='asis'}
df_productive <- read_tsv_with_dummy("files/non_clone_assigned_sequence.tsv")
kable(df_productive, format = "markdown", row.names = FALSE)
```
</details>
<br>
