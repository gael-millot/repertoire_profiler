...
See the passed_igblast_seq.tsv and the passed_igblast_seq.tsv files in the [tsv](./tsv) folder, as well as their [column description](https://github.com/gael-millot/repertoire_profiler?tab=readme-ov-file#output). 
...
See the productive_seq.tsv and the unproductive_seq.tsv files in the [tsv](./tsv) folder, as well as their [column description](https://github.com/gael-millot/repertoire_profiler?tab=readme-ov-file#output).
...
Compilation of the [productive_seq.tsv](./tsv) file (and also of the [germ_tree_seq.tsv](./tsv) file for the donut plots).
...
See the clone_assigned_seq.tsv and the non_clone_assigned_sequence.tsv (sequences from the productive file that fail to be clone-assigned by `DefineClones.py`) files in the [tsv](./tsv) folder, as well as their [column description](https://github.com/gael-millot/repertoire_profiler?tab=readme-ov-file#output).
