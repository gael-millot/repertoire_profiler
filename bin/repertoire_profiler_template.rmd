...
<br>
Only V, J and C genes are displayed here. See the [donuts.pdf](files/donuts.pdf) file in the files folder for the complete results, including the alleles (different copies of a same gene) proportions.
...
Click on a figure to enlarge. Reclick to go back to the report.
<br>
Only V, J and C genes are displayed here. See the [gene_repertoire.pdf](files/gene_repertoire.pdf) and [allele_repertoire.pdf](files/allele_repertoire.pdf) files in the files folder for the complete results, including the alleles (different copies of a same gene) counts.
