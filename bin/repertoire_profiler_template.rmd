...
<br>
Failed number of sequences: ```r params$nb_unigblast```
<br>
...
if(params$nb_productive != -1){
    ...
    cat('
Number of productive sequences: ', params$nb_productive,'&nbsp; <details class="inline"><summary style="color: #1a73e8; font-family: Arial, sans-serif; font-size: 1em; font-weight: bold;">view</summary>
...
<br>
Number of unproductive sequences: ', params$nb_unproductive, ' &nbsp; <details class="inline"><summary style="color: #1a73e8; font-family: Arial, sans-serif; font-size: 1em; font-weight: bold;">view</summary>
...
<br>
Number of wanted sequences: ', params$nb_wanted, '&nbsp; <details class="inline"><summary style="color: #1a73e8; font-family: Arial, sans-serif; font-size: 1em; font-weight: bold;">view</summary>
...
<br>
Number of unwanted sequences: ', params$nb_unwanted, ' &nbsp; <details class="inline"><summary style="color: #1a73e8; font-family: Arial, sans-serif; font-size: 1em; font-weight: bold;">view</summary>
...
###  Clonal prediction
```{r, echo=FALSE, results='asis'}
if(params$nb_productive != -1 && params$nb_wanted != -1 && params$nb_clone_assigned != -1){
    ...
    **Clone-assigned sequences** are wanted sequences with additionnal features:<br><ul><li>germline clustering (clone ID).<br></li><li>inference of clonal germline sequence (different from the sequence germline inference).<br></li><li>mutation load.<br></ul> 
    ...
    Number of clone-assigned sequences: ', nb_clone_assigned, '&nbsp; <details class="inline"><summary style="color: #1a73e8; font-family: Arial, sans-serif; font-size: 1em; font-weight: bold;">view</summary>
    ...
    <br>
    Number of sequences with failed clonal assignement: ', nb_failed_clone_assignment, ' &nbsp; <details class="inline"><summary style="color: #1a73e8; font-family: Arial, sans-serif; font-size: 1em; font-weight: bold;">view</summary>
    ...
    <br>
    Number of clone assigned sequences with failed germline sequence computation: ', nb_failed_clone_germline, ' &nbsp; <details class="inline"><summary style="color: #1a73e8; font-family: Arial, sans-serif; font-size: 1em; font-weight: bold;">view</summary>
