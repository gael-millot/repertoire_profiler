...
'))
    ...
    if(file.exists("vj_gene_tree_donutchart.png")){
        cat('<img src="vj_gene_tree_donutchart.png" onclick="toggleFullscreen(this)" style="border: 1px solid black"/>')
    }
    ...
    if(file.exists("c_gene_tree_donutchart.png")){
        cat('<img src="c_gene_tree_donutchart.png" onclick="toggleFullscreen(this)" style="border: 1px solid black"/>')
    }
    cat('</div><br><br><br>')
}else{
    cat(paste0('
