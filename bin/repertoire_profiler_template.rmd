...
See the [passed_igblast_seq.tsv](./tsv/passed_igblast_seq.tsv) and the [passed_igblast_seq.tsv](./tsv/failed_igblast_seq.tsv) files in the [tsv](./tsv) folder, as well as their [column description](https://github.com/gael-millot/repertoire_profiler?tab=readme-ov-file#output). 
...
Compilation of the [productive_seq.tsv](./tsv/productive_seq.tsv) file (and also of the [germ_tree_seq.tsv](./tsv/germ_tree_seq.tsv) file for the donut plots).
