...
<table style="width:100%; border-collapse:collapse; overflow-wrap: anywhere;table-layout:fixed; word-break:break-all;">
    ...
    <tr>
        ...
        <td style="white-space:normal; text-align:left; word-break:break-all; overflow-wrap:anywhere;">
            ...
            <br></li><li><b>clonal_germline_sequence_with_gaps</b>: identical to germline_alignment_(full | d_mask | v_region)_no_gaps column renamed for commodity.
            <br></li><li><b>clonal_germline_sequence_no_gaps</b>: sequence of the clonal_germline_sequence_with_gaps column without the IMGT-gaps spacers (dots).
            <br></li><li><b>clonal_germline_alignment_igblast_airr</b>: control column. 'sequence_alignment' field output of the `AssignGenes.py igblast --format airr` command processing the sequence of the <i>clonal_germline_sequence_no_gaps</i> column in order to retrieve region coordinates. Thus, this sequence should not have any IMGT-gaps spacers (dots) as explain above for the <i>sequence_alignment</i> field.
            <br></li><li><b>clonal_germline_alignment_aa_igblast_airr</b>: control column. 'sequence_alignment_aa' field output of the `AssignGenes.py igblast --format airr` command processing the sequence of the <i>clonal_germline_sequence_no_gaps</i> column in order to retrieve region coordinates.
