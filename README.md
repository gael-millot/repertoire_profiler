...
<table style="width:100%; border-collapse:collapse; overflow-wrap: anywhere;table-layout:fixed; word-break:break-all;">
    ...
    <tr>
        ...
        <td style="white-space:normal; text-align:left; word-break:break-all; overflow-wrap:anywhere;">
            ...
            <br></li><li><b>clonal_germline_alignment</b>: equivalent of the <i>sequence_alignment</i> column output but for the sequence of the germline_alignment_(full | d_mask | v_region) column after processing by `AssignGenes.py igblast --format airr`. This sequence should not have any IMGT-gaps spacers (dots).
            <br></li><li><b>clonal_germline_alignment_aa</b>: translation of the germline_alignment_(full | d_mask | v_region) sequence processed by `AssignGenes.py igblast --format airr`. This sequence should be identical to the sequence of the <i>germline_alignment_(full | d_mask | v_region)_aa_no_gaps</i> column.
