...
<copy-pre><button type="button" class="btn btn-default btn-md gl-button btn-icon has-tooltip" data-title="Copy to clipboard"><svg><use xlink:href="/assets/icons-5f28ad8ab3377176325e2edb59a58c34611f3e7e6720f4a6096d8105813fafec.svg#copy-to-clipboard"></use></svg></button></copy-pre>
